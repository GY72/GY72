...
#define WDT_SET_4096ms        RSTSTAT = (RSTSTAT & 0xF8);
...
//when code option OP_OSC =0000,OSC1CLK is internal 16.6MHz RC,OSC2CLK is Disable 
#define SET_MCU_CLK_RC_16P6M  CLKCON = (CLKCON & 0x9F);
#define SET_MCU_CLK_RC_8P3M   CLKCON = (CLKCON & 0x9F) | 0x20;
#define SET_MCU_CLK_RC_4P15M  CLKCON = (CLKCON & 0x9F) | 0x40;    
#define SET_MCU_CLK_RC_1P38M  CLKCON = (CLKCON & 0x9F) | 0x60;

//Touch Key
#define Enable_TK             TKCON1 |= 0x80;
...
#define TK_is_Going           (TKF0 & 0xFB) == 0x00
...
#define DIS_ALL_TK_Chn        P2SS = 0x00;  TKU1 = 0x00;

#define TK_DATA_RAM_ADDR      0x0500

//Buzzer
#define Enable_BUZ            BUZCON |= 0x80;
#define Disable_BUZ           BUZCON &= 0x7F;
#define OUTPUT_SEL_BUZ1       BUZCON &= 0xBF;
#define OUTPUT_SEL_BUZ2       BUZCON |= 0x40;
#define BUZCK_SEL_SCK_D_256   BUZCON = (BUZCON & 0xF3);
#define BUZCK_SEL_SCK_D_64    BUZCON = (BUZCON & 0xF3) | 0x04;
#define BUZCK_SEL_SCK_D_16    BUZCON = (BUZCON & 0xF3) | 0x08;
#define BUZCK_SEL_SCK_D_4     BUZCON = (BUZCON & 0xF3) | 0x0C;
